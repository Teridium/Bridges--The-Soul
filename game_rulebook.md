...
*   **Правила для предметов с `+ МЗД`:**
    ...
    *   Когда происходит одевание предмета в момент его получения `+ МЗД`, то сразу после этого персонажа лечат на значение, равное `+ МЗД`
...
*   **Формула вычисления урона:** (урон_персонажа + бонусы_от_оружия) * множитель_метки
...
*   Любой игрок в свой ход без какой-либо траты ОД может сделать следующие действия:
    ...
    *   **Возврат Руки:** Отдав Раздвижную руку Ремесленнику, он даст вам 5 монет. *"Верни ему руку!"*
