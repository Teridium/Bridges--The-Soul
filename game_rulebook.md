...
*   **Формула вычисления урона:** `((Персонаж + Оружие_с_бонусом) или Оружие_со_своим_уроном) * Метка`. Можно выбирать между уроном от персонажа и уроном от оружий со своим уроном
...
*   **Поведение:**
    *   Если на его острове 2 или более игроков: использует `Огненный шар`. Иначе: использует `Луч пекла`
...
*   Любой игрок в свой ход без какой-либо траты ОД может сделать следующие действия:
    ...
    *   **Возврат Руки:** Показав Раздвижную руку Ремесленнику (надо просто прийти к ремесленнику, когда в Банке есть Рука), открывается торг `Раздвижная рука` за 2 монеты. *"Верни ему руку!"*
