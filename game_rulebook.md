...
*   **Экспериментальная техника нападения:**
    *   Каждый персонаж может совершить одну экспериментальную технику нападения за раунд (в течение Фазы Действий Игроков). Для этого, объявляя атаку, игрок может рискнуть и бросить d6. Результат влияет на урон этой атаки:
        *   6: **+2** урона
        *   5: **+1** урон
...
*   **Особое:**
    *   Атакует только в ответ. Начинает атаковать самостоятельно, если Темный стрелок мертв
*   **Поведение:**
    *   Если Темный стрелок мертв: Использует `Луч пекла` на персонажа на его острове или на соседнем острове в свой ход, если есть такой персонаж
*   **Контратака:**
...
*   **Умения:**
    ...
    *   `Огненный шар`: 1 УРН всем на острове, без ответа

### Карате-бомж
*   **Характеристики:** 6*N МЗД
*   **Дроп:**
    *   1: `Двуручник`, 3 монеты
    *   2: `Раздвижная рука`, 2 монеты
    *   3: `Бомба` x3, 2 монеты
...
*   **Дроп:**
    *   1: `Рекурсивный лук`, `Пружина`, 4 монеты
    *   2: `Арбалет`, 5 монеты
    *   3: `Пружина` x4, 1 монета
...
|:--- |:--- |
| 1 | Рекурсивый лук (1), Посох лесов (2) |
