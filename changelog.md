...
### 3.6.5: Отториноларингология
*   Обновление ачивок
*   Массивный апдейт лора до текущего времени

### 3.6.4: Ограниченное внимание
*   Боссы и игроки теперь могут контратаковать лишь раз за раунд (кроме Крабулона, он крутой)
*   Количество игроков ограничено до 4
*   Обновление опросника
*   Правки ЛОРа

### 3.6.3: Э-э-эксперименты!
*   Бомба теперь взрывается быстрее, после фазы нейтралов в раунде ее установки
*   Обостренный панцирь перестал накладывать ограничения по скорости
*   Мастер занерфлен (опять): теперь лишь скидка на постройку в одну монету
*   Эксперимент: Тролль Хоттабыч (trl) и северный сундук (chn) поменялись местами
*   Эксперимент: Игра не заканчивается, когда кто-то падает! Теперь его можно вылечить Зельями Лечения и прочими подобными предметами

### 3.6.2: Оверхаул построек, работаем
*   Ридми обновлен, наканецта!
*   Укрепления подешевели на 1 монетку (было 3, стало 2)
*   Катапульта теперь строится заряженной
*   Катапульте добавилось новое действие: Запуск камушка, позволяющее наносить урон на расстоянии, но вызывает дальнюю контратаку со стороны босса, которая идет по катапульте, а не по игроку!
*   Катапульта теперь имеет 5 МЗД
*   (ДЛС) Новая постройка: Зелье-на-палке! Увеличивает урон всех игроков, кто стоит на острове, стоит Зелье лечения!
*   (ДЛС) Новая постройка: ~~Казино~~ Карьер! Возвращает богом забытую механику копания в новом азартном виде!

### 3.6.1: Черепаховый супец
*   Ловушки Скаута теперь острые и наносят 1 урон
*   Попытка Масетра стать полезным: он снова тратит ОД на постройки, но теперь эти самые постройки не требуют монет для него. Он типа собирает их из подручных материалов
*   А еще Мастер может разбирать предметы в монетки!
*   Запеканка стал более оборонистым, атакую в свой ход, если его атаковали
*   Но потерял свою странную рефлекторную способность
*   Все боссы обеднели на 1 монету
*   Побалансировали дроп Запеканки
*   Обостренный панцирь активируется только на ближние атаки, но наносит 2 урона
*   Урон бомбы теперь по формуле УРН = 3*N
*   Закончена более-менее первая часть ДЛС

### 3.6.0: Подготовка к большему
*   Улучшены боссы
    *   Темный Стрелок снова обрел свои чуткие рефлексы
    *   Колдун Запеканка стал отвечать на неотвечаемые атаки! Откуда такие рефлексы?
    *   Улучшен баланс новых дропов с боссов
    *   Добавлены атаки лечения Запеканке и Големко!
    *   Расписаны приоритеты атак
*   Магия посоха Лесов стала тяжелой, теперь он занимает обе руки. К чему бы это?
*   Прописано наконец, что атаковать можно только по тем, кто стоит на том же острове, что и атакующий, за несколькими исключениями
*   Обновлены ачивки
*   Хоттабыч переложил ответсвенность произовдства зелий лечения на Ремесленника
*   Добавлен новый предмет и по совместительству броня - Обостренный панцирь. Сделано и продаваемо Хоттабычем
*   Сырье для Шариков-со-Щитами подешевело, что привело к их снижению в цене до 2 монет (было 3)
*   Улучшен баланс стартовых наборов

### 3.5.5: Смолпук
*   Исправлена критические недосказанности и логические ошибки в поведениии нашего любимого Колдуна-интроверта. Теперь все норм
*   Уточнены некоторые правила
    *   Теперь дейсвия на базе реально действия, лол
*   Изменения слухов о Бомже, что связывает его с неким "воином"
*   Улучшен ЛОР!!! Бегите читать, задроты!
...
*   Скаут теперь вместо места возрождения (наконец) может "двигать" союзников
...
*   У потомков "Торгаша" и "Инженера" появился человек, который стал "Мастером (на все руки)" (они были объединены)
*   "Щитовик" был объединен с "Копателем" в нового "Буриллу" (наверняка он проникся их мудростями)
*   Все многообразие типов урона и защиты было сведено к единым показателям "УРН" и "МЗД"
*   Характеристика "ЗАЩ" и "МН" с "ВМН" были удалены. Над удалением Защиты думали долго
*   Количество персонажей под управлением игрока сократилось с двух до одного
*   Классы, такие как Воин, Стрелок, Щитовик, Копатель, Скаут ушли на пенсию (удалены, Скаут тоже вроде ушел, но по моему что-то не чисто это все), а некоторые из них частично передали способности другим классам (через их писания, те самые книги мастерства)
...
*   В мире появились боссы: Големко (это тот самый Големко из ненужных классов, но он подрос заметно), Запеканка, Бомж, Крабулон, Темный стрелок
...
*   Системы сундуков и добычи денег были переработаны с использованием множества случайных бросков кубиков.
    *   Сундуки превратились в источники артефактов
    *   Чтобы получать деньги нужно было исследовать остров, чтобы узнать его богатство и копать его, чтобы получать столько монет, сколько и богатство острова.
    *   Скаут превратился в разведчика, специализирующийся на этом занятии
*   Новая система "книг Мастерства". Это такие книги, которые пишет персонаж, когда набирается опыта (в этой версии выполняя свое действие до момента, когда на кубике выпадет нужное число)
...
### 1.1: Скользкая дорожка
*   Добавлены имбалансные Гарпунщик и Мистер Ку и нормальные Торговец, Инженер, Скаут и Копатель

### 1.0: Основание игры "Мосты"
*   **Концепция:** Соревновательная PvP игра для 4 игроков на сетке 5x5, соединенных провалами, с целью захвата флагов
*   **Характеристики:** Существовала базовая система характеристик и система уровней у торговцев
*   **Классы:** Было 4 стартовых классов: Маг, Воин, Стрелок и Щитовик
*   **Предметы:** Было 4 категории предметов: Броня, Ближнее оружие, Стрелковое оружие и Магические посоха. Каждая из них содержала по 5 предметов восходящего уровня.
