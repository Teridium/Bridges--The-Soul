...
*   Бомж теперь быстро хватает монетки, но зато полностю становится добрым
*   У всех боссов четко прописаны контратаки и атаки
*   Лагерь теперь стоит 2 монеты
*   Дирижабль позволяет дистанционно покупать предметы на Базе и у Хоттабыча на острове Хоттабыча и на Базе соответственно
